...
3. Get a copy of any local dependencies and place it into `libs`:
   ...
   - Cronet, somehow fails dependency verification with an infinite loop during Studio Gradle sync,
     just use AARs instead.   
