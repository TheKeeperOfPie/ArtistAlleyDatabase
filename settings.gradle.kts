...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            plugin("com.apollographql.apollo3.external").version("3.8.1")
            ...
            library("com.apollographql.apollo3:apollo-runtime:3.8.1")
            library("com.google.accompanist:accompanist-flowlayout:0.31.1-alpha")
            library("com.google.accompanist:accompanist-placeholder-material:0.31.1-alpha")
            library("com.google.accompanist:accompanist-navigation-animation:0.31.1-alpha")
            ...
            library("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.0-RC")
            library("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.7.0-RC")
            library("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.7.0-RC")
            library("org.jetbrains.kotlinx:kotlinx-serialization-json:1.5.0")
            library("org.junit.jupiter:junit-jupiter-api:5.9.3")
            library("org.junit.jupiter:junit-jupiter-engine:5.9.3")
