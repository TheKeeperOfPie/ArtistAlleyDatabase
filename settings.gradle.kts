...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            plugin("com.apollographql.apollo3.external").version("4.0.0-alpha.1")
            ...
            library("androidx.activity:activity-compose:1.8.0-alpha05")
            library("androidx.compose.material3:material3:1.2.0-alpha02")
            library("androidx.compose.material:material-icons-core:1.5.0-beta02")
            library("androidx.compose.material:material-icons-extended:1.5.0-beta02")
            library("androidx.compose.material:material:1.5.0-beta02")
            ...
            library("androidx.test:runner:1.6.0-alpha02", alias = "androidx.test.runner")
            library("androidx.work:work-runtime-ktx:2.8.1")
            library("androidx.work:work-runtime:2.8.1")
            library("com.apollographql.apollo3:apollo-runtime:4.0.0-alpha.1")
            library("com.google.accompanist:accompanist-flowlayout:0.31.3-beta")
            library("com.google.accompanist:accompanist-placeholder-material:0.31.3-beta")
            library("com.google.accompanist:accompanist-navigation-animation:0.31.3-beta")
            library("com.google.accompanist:accompanist-pager-indicators:0.31.3-beta")
            ...
            library("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.7.1")
            ...
            prefix("compose") {
                library("androidx.compose.animation:animation:1.5.0-beta02")
                library("androidx.compose.ui:ui-test-manifest:1.5.0-beta02")
                library("androidx.compose.ui:ui-tooling-preview:1.5.0-beta02")
                library("androidx.compose.ui:ui-tooling:1.5.0-beta02")
                library("androidx.compose.ui:ui:1.5.0-beta02")
            }
            prefix("junit5") {
