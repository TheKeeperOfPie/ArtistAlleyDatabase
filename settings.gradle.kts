...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("libs") {
            ...
            library("androidx.media3:media3-datasource-cronet:1.1.0-alpha01")
            library("androidx.media3:media3-exoplayer:1.1.0-alpha01")
            library("androidx.media3:media3-exoplayer-dash:1.1.0-alpha01")
            library("androidx.media3:media3-exoplayer-hls:1.1.0-alpha01")
            library("androidx.media3:media3-exoplayer-rtsp:1.1.0-alpha01")
            library("androidx.media3:media3-ui:1.1.0-alpha01")
            ...
            library("com.google.accompanist:accompanist-flowlayout:0.31.2-alpha")
            library("com.google.accompanist:accompanist-placeholder-material:0.31.2-alpha")
            library("com.google.accompanist:accompanist-navigation-animation:0.31.2-alpha")
            ...
            library("org.chromium.net:cronet-embedded:108.5359.79")
