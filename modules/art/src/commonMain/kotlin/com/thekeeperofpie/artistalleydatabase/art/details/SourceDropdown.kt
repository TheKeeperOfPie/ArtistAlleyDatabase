...
object SourceDropdown {
    ...
    internal fun ConventionSection(
        ...
        Column(
            ...
            val showSecondRow by remember {
                derivedStateOf {
                    lockState() != EntryFormSection.LockState.LOCKED ||
    ...
    @Stable
    class State(
        val dropdown: EntryFormSection.Dropdown,
    ...
    fun rememberState(
        ...
        val dropdownState = rememberSaveable(saver = EntryFormSection.Dropdown.Saver) {
            EntryFormSection.Dropdown(initialSelectedIndex)
        }
