...
@Suppress("UNCHECKED_CAST")
fun <T> ImmutableList<T>?.orEmpty(): ImmutableList<T> = this ?: (EmptyImmutableList as ImmutableList<T>)

@Suppress("UNCHECKED_CAST")
fun <K, V> ImmutableMap<K, V>?.orEmpty(): ImmutableMap<K, V> = this ?: (EmptyImmutableMap as ImmutableMap<K, V>)
