...
import artistalleydatabase.modules.anilist.generated.resources.aniList_oAuth_login_menu_action
...
class AniListOAuthTrampolineActivity : ComponentActivity() {
    ...
    override fun onResume() {
        ...
        val actionButtonText = runBlocking { getString(Res.string.aniList_oAuth_login_menu_action) }
        ...
        PlatformOAuthStore.setShareTargetEnabled(application, true)
        CustomTabsIntent.Builder()
            .setActionButton(actionIcon, actionButtonText, pendingIntent)
            .build()
            .launchUrl(this, Uri.parse(PlatformOAuthStore.ANILIST_OAUTH_URL))
