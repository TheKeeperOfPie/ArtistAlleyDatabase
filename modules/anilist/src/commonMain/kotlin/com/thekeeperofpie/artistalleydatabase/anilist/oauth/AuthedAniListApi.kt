...
open class AuthedAniListApi(
        ...
        SaveMediaListEntryMutation(
            ...
            startedAt = Optional.present(startedAt?.let {
                FuzzyDateInput(
                    ...
                    month = Optional.present(it.month.number),
                    day = Optional.present(it.day),
                )
            }),
    ...
    open suspend fun userSocialActivity(
        ...
        UserSocialActivityQuery(
            ...
            typeIn = Optional.presentIfNotNull(typeIn?.ifEmpty { null }),
            typeNotIn = Optional.presentIfNotNull(typeNotIn?.ifEmpty { null }),
