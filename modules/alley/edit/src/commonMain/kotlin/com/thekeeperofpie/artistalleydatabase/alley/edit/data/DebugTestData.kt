...
object DebugTestData {
    ...
    private suspend fun initializeTestStampRally(database: AlleyEditRemoteDatabase): StampRallyDatabaseEntry {
        ...
        var previous = StampRallyDatabaseEntry(
            ...
            startTables = setOf("C38"),
            endTables = setOf("C38", "C39"),
            links = emptyList(),
            tableMin = TableMin.Price(5),
            totalCost = 15,
            prize = "3 charms, sticker pack, risograph",
            prizeLimit = 50,
            prizeMerch = listOf("Charms", "Prints", "Stickers"),
            series = listOf("Vocaloid", "Original"),
            merch = listOf("Stickers", "Photocards"),
            notes = null,
            images = emptyList(),
            confirmed = false,
