...
fun rememberPullRefreshState(
    ...
    val state = remember(scope) {
        PullRefreshState(scope, onRefreshState, refreshingOffsetPx, thresholdPx, resetAfterPull)
    }
...
class PullRefreshState internal constructor(
    ...
    threshold: Float,
    private val resetAfterPull: Boolean,
) {
    /**
    ...
    internal fun onRelease(velocity: Float): Float {
        ...
        if (resetAfterPull || adjustedDistancePulled <= threshold) {
