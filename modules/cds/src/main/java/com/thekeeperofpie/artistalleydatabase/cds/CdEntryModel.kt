...
data class CdEntryModel(
    ...
    val vocalists: List<EntrySection.MultiText.Entry>,
    ...
    val vocalistsLocked: EntrySection.LockState?,
    ...
    constructor(
        ...
        vocalists: List<EntrySection.MultiText.Entry>,
        ...
        vocalistsLocked = EntrySection.LockState.from(entry.locks.vocalistsLocked),
