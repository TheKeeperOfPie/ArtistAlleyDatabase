...
import artistalleydatabase.modules.cds.generated.resources.cd_entry_catalog_header
import artistalleydatabase.modules.cds.generated.resources.cd_entry_characters_header_many
import artistalleydatabase.modules.cds.generated.resources.cd_entry_characters_header_one
import artistalleydatabase.modules.cds.generated.resources.cd_entry_characters_header_zero
import artistalleydatabase.modules.cds.generated.resources.cd_entry_composers_header_many
import artistalleydatabase.modules.cds.generated.resources.cd_entry_composers_header_one
import artistalleydatabase.modules.cds.generated.resources.cd_entry_composers_header_zero
import artistalleydatabase.modules.cds.generated.resources.cd_entry_notes_header
import artistalleydatabase.modules.cds.generated.resources.cd_entry_performers_header_many
import artistalleydatabase.modules.cds.generated.resources.cd_entry_performers_header_one
import artistalleydatabase.modules.cds.generated.resources.cd_entry_performers_header_zero
import artistalleydatabase.modules.cds.generated.resources.cd_entry_series_header_many
import artistalleydatabase.modules.cds.generated.resources.cd_entry_series_header_one
import artistalleydatabase.modules.cds.generated.resources.cd_entry_series_header_zero
import artistalleydatabase.modules.cds.generated.resources.cd_entry_tags_header_many
import artistalleydatabase.modules.cds.generated.resources.cd_entry_tags_header_one
import artistalleydatabase.modules.cds.generated.resources.cd_entry_tags_header_zero
import artistalleydatabase.modules.cds.generated.resources.cd_entry_title_header_many
import artistalleydatabase.modules.cds.generated.resources.cd_entry_title_header_one
import artistalleydatabase.modules.cds.generated.resources.cd_entry_title_header_zero
...
class CdEntrySections(
    ...
    val catalogIdSection = EntrySection.MultiText(
        Res.string.cd_entry_catalog_header,
        Res.string.cd_entry_catalog_header,
        Res.string.cd_entry_catalog_header,
    ...
    val titleSection = EntrySection.MultiText(
        Res.string.cd_entry_title_header_zero,
        Res.string.cd_entry_title_header_one,
        Res.string.cd_entry_title_header_many,
        lockState = defaultLockState,
    )

    val performerSection = EntrySection.MultiText(
        Res.string.cd_entry_performers_header_zero,
        Res.string.cd_entry_performers_header_one,
        Res.string.cd_entry_performers_header_many,
        lockState = defaultLockState,
    )

    val composerSection = EntrySection.MultiText(
        Res.string.cd_entry_composers_header_zero,
        Res.string.cd_entry_composers_header_one,
        Res.string.cd_entry_composers_header_many,
        lockState = defaultLockState,
    )

    val seriesSection = EntrySection.MultiText(
        Res.string.cd_entry_series_header_zero,
        Res.string.cd_entry_series_header_one,
        Res.string.cd_entry_series_header_many,
        lockState = defaultLockState,
    )

    val characterSection = EntrySection.MultiText(
        Res.string.cd_entry_characters_header_zero,
        Res.string.cd_entry_characters_header_one,
        Res.string.cd_entry_characters_header_many,
        lockState = defaultLockState,
    )
    ...
    val tagSection = EntrySection.MultiText(
        Res.string.cd_entry_tags_header_zero,
        Res.string.cd_entry_tags_header_one,
        Res.string.cd_entry_tags_header_many,
        lockState = defaultLockState,
    )

    val notesSection = EntrySection.LongText(
        headerRes = Res.string.cd_entry_notes_header,
        lockState = defaultLockState,
    )
                        ...
                        .flatMapLatest {
                            it.map {
                                ...
                                flow { emitNotNull(vgmdbApi.getAlbum(albumId)) }
                                    .catch {
                                        Logger.d(TAG, it) { "Error fetching album $albumId" }
                                    }
