...
import artistalleydatabase.modules.cds.generated.resources.cd_entry_catalogId_unlocked_indicator_content_description
import artistalleydatabase.modules.cds.generated.resources.cd_entry_characters_unlocked_indicator_content_description
import artistalleydatabase.modules.cds.generated.resources.cd_entry_composers_unlocked_indicator_content_description
import artistalleydatabase.modules.cds.generated.resources.cd_entry_discs_unlocked_indicator_content_description
import artistalleydatabase.modules.cds.generated.resources.cd_entry_performers_unlocked_indicator_content_description
import artistalleydatabase.modules.cds.generated.resources.cd_entry_series_unlocked_indicator_content_description
import artistalleydatabase.modules.cds.generated.resources.cd_entry_title_unlocked_indicator_content_description
...
import com.thekeeperofpie.artistalleydatabase.icons.automirrored.outlined.ShortText
import com.thekeeperofpie.artistalleydatabase.icons.outlined.DiscFull
import com.thekeeperofpie.artistalleydatabase.icons.outlined.Info
import com.thekeeperofpie.artistalleydatabase.icons.outlined.MicNone
import com.thekeeperofpie.artistalleydatabase.icons.outlined.Monitor
import com.thekeeperofpie.artistalleydatabase.icons.outlined.MusicNote
            ...
            FlowRow(
                ...
                if (catalogIdError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_catalogId_unlocked_indicator_content_description,
                        ),
                ...
                if (titleError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_title_unlocked_indicator_content_description,
                        ),
                        tint = MaterialTheme.colorScheme.error,
                        modifier = Modifier.size(12.dp)
                    )
                ...
                if (performersError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_performers_unlocked_indicator_content_description,
                        ),
                        tint = MaterialTheme.colorScheme.error,
                        modifier = Modifier.size(12.dp)
                    )
                ...
                if (composersError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_composers_unlocked_indicator_content_description,
                        ),
                        tint = MaterialTheme.colorScheme.error,
                        modifier = Modifier.size(12.dp)
                    )
                ...
                if (seriesError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_series_unlocked_indicator_content_description,
                        ),
                        tint = MaterialTheme.colorScheme.error,
                        modifier = Modifier.size(12.dp)
                    )
                ...
                if (charactersError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_characters_unlocked_indicator_content_description,
                        ),
                        tint = MaterialTheme.colorScheme.error,
                        modifier = Modifier.size(12.dp)
                    )
                ...
                if (discsError) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.cd_entry_discs_unlocked_indicator_content_description,
                        ),
                        tint = MaterialTheme.colorScheme.error,
                        modifier = Modifier.size(12.dp)
                    )
