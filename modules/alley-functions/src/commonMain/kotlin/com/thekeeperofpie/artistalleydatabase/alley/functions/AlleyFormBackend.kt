...
internal object AlleyFormBackend {
    ...
    private suspend fun saveArtist(
        ...
        val finalizedStampRallies = request.afterStampRallies.map { after ->
            ...
            val finalizedId = if (after.id.isEmpty() || before == null) {
                Uuid.random()
            } else {
                Uuid.parse(after.id)
            }
        ...
        val deletedStampRallies = request.deletedRallyIds
            .map {
                StampRallyFormEntry(
                    ...
                    beforeFandom = null,
                    beforeTables = null,
                    beforeStartTables = null,
                    beforeEndTables = null,
                    beforeLinks = null,
                    beforeTableMin = null,
                    beforePrize = null,
                    beforePrizeLimit = null,
                    beforePrizeMerch = null,
                    beforeSeries = null,
                    beforeMerch = null,
                    beforeNotes = null,
                    beforeImages = null,
                    afterFandom = null,
                    afterTables = null,
                    afterStartTables = null,
                    afterEndTables = null,
                    afterLinks = null,
                    afterTableMin = null,
                    afterPrize = null,
                    afterPrizeLimit = null,
                    afterPrizeMerch = null,
                    afterSeries = null,
                    afterMerch = null,
                    afterNotes = null,
                    afterImages = null,
