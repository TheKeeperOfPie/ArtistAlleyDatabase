...
interface CharactersComponent {
    ...
    val characterSortFilterViewModel: (ScopedSavedStateHandle, CharacterSortFilterViewModel.InitialParams) -> CharacterSortFilterViewModel
    val characterMediaSortFilterViewModel: (ScopedSavedStateHandle, CharacterMediaSortFilterViewModel.InitialParams) -> CharacterMediaSortFilterViewModel
