...
open class AnimeSortFilterController<SortType : SortOption>(
    ...
    protected val episodesSection = SortFilterSection.Range(
        titleRes = Res.string.anime_media_filter_episodes_label,
        titleDropdownContentDescriptionRes = Res.string.anime_media_filter_episodes_expand_content_description,
