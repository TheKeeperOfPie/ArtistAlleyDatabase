...
class AnimeUserListSortFilterViewModel(
...
) : AnimeSortFilterViewModel<MediaListSortOption>(
    ...
    class TypedFactory(
        ...
        fun create(initialParams: InitialParams<MediaListSortOption>) =
            AnimeUserListSortFilterViewModel(
                aniListApi = aniListApi,
                featureOverrideProvider = featureOverrideProvider,
                json = json,
                mediaGenresController = mediaGenresController,
