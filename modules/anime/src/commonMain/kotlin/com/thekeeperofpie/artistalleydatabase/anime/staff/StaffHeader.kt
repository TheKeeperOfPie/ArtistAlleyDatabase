        ...
        Row(verticalAlignment = Alignment.Bottom) {
            ...
            Box {
                ...
                IconButton(onClick = { showMenu = true }) {
                    Icon(
                        ...
                        contentDescription = stringResource(
                            Res.string.anime_staff_details_more_actions_content_description,
                        ),
                    )
                }
                ...
                DropdownMenu(
                    ...
                    DropdownMenuItem(
                        text = { Text(stringResource(Res.string.anime_staff_details_open_external)) },
                        leadingIcon = {
                            Icon(
                                imageVector = Icons.Filled.OpenInBrowser,
                                contentDescription = stringResource(
                                    Res.string.anime_staff_details_open_external_icon_content_description
                                )
                            )
                        },
                        onClick = {
